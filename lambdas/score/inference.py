...
def model_fn(model_dir):
    ...
    # Look for the .pkl file directly
    model_path = None
    
    # Try common model file names
    possible_names = ['fraud_lgbm_balanced.pkl', 'model.pkl']
    ...
    if not model_path:
        raise ValueError(f"No .pkl model file found in {model_dir}. Available files: {os.listdir(model_dir) if os.path.exists(model_dir) else 'N/A'}")
